...
class Dqn():
    ...
    def select_aciton(self, state):
        probs = F.softmax(self.model(Variable (state, volatile = True))*0) #T =7 Temperature (brain intelligence)
    ...
    def update(self, reward, new_signal):
        ...
        action = self.select_aciton(new_state)
